...
grid.arrange(fix)
ggsave("./output_files/Fig4b_TFi_comp_scatter.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE4c_TFi_comp_act_venn.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE4d_TFi_comp_rep_venn.pdf", fix, dpi = 300,
       useDingbats=FALSE)

...
grid.arrange(fix)
ggsave("./output_files/FigE7c_REPi_log2_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE7d_REPi_NTC_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
pearson_fun <- function(a) {
  ...
  ggsave(paste0("./output_files/FigE7e_REPi_", a,  "_pearson.pdf"),cor_heat, dpi = 300,
         useDingbats=FALSE)
}

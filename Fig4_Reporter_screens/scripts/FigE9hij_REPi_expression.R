...
heat_fun <- function(a) {
  ...
  ggsave(paste0("./output_files/E9h_", a, "_act_expression_heat.pdf"), heat, dpi = 300,
         useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE9i_cluster_expression.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE9j_sex_expression.pdf", fix, dpi = 300,
       useDingbats=FALSE)

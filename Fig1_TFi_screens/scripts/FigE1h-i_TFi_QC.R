...
grid.arrange(fix)
ggsave("./output_files/FigE1h_TFi_log2_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE1h_TFi_NTC_log2_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE1i_TFi_correlation_density.pdf", fix, dpi = 300,
         useDingbats=FALSE)

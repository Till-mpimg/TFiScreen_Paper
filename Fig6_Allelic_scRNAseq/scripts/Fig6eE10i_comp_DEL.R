...
pval <- wilcox.test(sum_df[sum_df$sample=="WT",]$chrX_ratio, sum_df[sum_df$sample =="dFtx-Xert",]$chrX_ratio)$p.value
pval
...
ggsave("./output_files/FigE10i_WT_DEL_gene_ratios.pdf", fix_ratio_hc, 
       useDingbats=FALSE)

...
grid.arrange(fix)
ggsave("./output_files/FigE3f_TFiMini_log2_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE3f_TFiMini_NTC_log2_width.pdf", fix, dpi = 300,
       useDingbats=FALSE)
...
grid.arrange(fix)
ggsave("./output_files/FigE3g_TFiMini_correlation_density.pdf", fix, dpi = 300,
         useDingbats=FALSE)
